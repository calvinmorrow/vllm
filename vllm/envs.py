...
if TYPE_CHECKING:
    ...
    VLLM_BREAKABLE_CUDAGRAPH_DIAGNOSTICS: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Emit worker-local aggregate counters for breakable cudagraph debugging.
    "VLLM_BREAKABLE_CUDAGRAPH_DIAGNOSTICS": lambda: (
        os.environ.get("VLLM_BREAKABLE_CUDAGRAPH_DIAGNOSTICS", "0") == "1"
    ),
