...
def test_log_block_fp8_shapes_env() -> None:
    with patch.dict(os.environ, {}, clear=True):
        assert environment_variables["VLLM_LOG_BLOCK_FP8_SHAPES"]() is False

    with patch.dict(
        os.environ, {"VLLM_LOG_BLOCK_FP8_SHAPES": "1"}, clear=True
    ):
        assert environment_variables["VLLM_LOG_BLOCK_FP8_SHAPES"]() is True
